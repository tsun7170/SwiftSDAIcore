...
extension SDAI {
  ...
  public protocol ArrayType:
    ...
    SDAI.Initializable.BySwifttypeAsArray, SDAI.Initializable.ByArrayLiteral, SDAI.Initializable.ByGenericArray, SDAI.Initializable.ByGenericArrayOptional
  {
...
extension SDAI {
  ...
  public struct ARRAY<ELEMENT:SDAI.GenericType>: SDAI.TypeHierarchy.ARRAY__TypeBehavior
    ...
    ) -> SDAIPopulationSchema.WhereRuleValidationRecords
    {
		...
		//MARK: SDAI.UnderlyingType \SDAI.AggregationType\SDAI__ARRAY_OPTIONAL__type\SDAI__ARRAY__type
