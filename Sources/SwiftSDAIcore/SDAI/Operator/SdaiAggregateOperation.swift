...
// Aggregate + Bag = Bag
public func + <T: SDAIAggregationInitializer, U: SDAI__BAG__type>	(lhs: T?, rhs: U?) -> SDAI.BAG<T.ELEMENT>? 	where T.ELEMENT: SDAIGenericType, T.ELEMENT.FundamentalType == U.ELEMENT.FundamentalType { abstruct() }
...
// Aggregate + Set = Set
public func + <T: SDAIAggregationInitializer, U: SDAI__SET__type>	(lhs: T?, rhs: U?) -> SDAI.SET<T.ELEMENT>? 	where T.ELEMENT: SDAIGenericType, T.ELEMENT.FundamentalType == U.ELEMENT.FundamentalType { abstruct() }
...
// Aggregate + List = List
public func + <T: SDAIAggregationInitializer, U: SDAIListType>		(lhs: T?, rhs: U?) -> SDAI.LIST<T.ELEMENT>?	where T.ELEMENT: SDAIGenericType, T.ELEMENT.FundamentalType == U.ELEMENT.FundamentalType { abstruct() }
